                                        ...
                                        <tbody id="companyTable">
                                            @foreach($companies as $key => $company)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        @if($company->logo)
                                                            <img src="{{ asset('storage/' . $company->logo) }}" width="40" height="40" alt="Logo" class="rounded-circle">
                                                        @else
                                                            <span>No Logo</span>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span class="badge change-status 
                                                            {{ $company->company_status == 'Active' ? 'bg-primary' : 'bg-danger' }} 
                                                            text-uppercase" 
                                                            data-id="{{ $company->id }}" 
                    ...
                    if (confirm(`Change status to ${newStatus}?`)) {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                this.classList.toggle('bg-primary', newStatus === 'Active');
                                this.classList.toggle('bg-danger', newStatus === 'Inactive');
