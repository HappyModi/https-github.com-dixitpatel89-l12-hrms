!(function () {
    ...
    function f(e) {
        document.getElementById("header-lang-img") &&
            ...
            null == (b = localStorage.getItem("language")) && f(g),
        ...
        Array.from(n).forEach(function (e, t) {
            t + 1 === a && (s = e),
                ...
                t + 1 === n.length &&
                    ...
                    s.insertAdjacentHTML(
                        "afterend",
                        '<li class="nav-item">\t\t\t\t\t\t<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">\t\t\t\t\t\t\t<i class="las la-briefcase"></i> More\t\t\t\t\t\t</a>\t\t\t\t\t\t<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' +
                            o +
                            "</ul></div>\t\t\t\t\t</li>"
                    );
        });
    ...
    sessionStorage.getItem("defaultAttribute")
        ? (((a = {})["data-layout"] = sessionStorage.getItem("data-layout")),
          ...
          x(a))
        : ((r = document.documentElement.attributes),
          (a = {}),
